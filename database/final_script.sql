...
drop table sub_take_up
drop table subshifts
drop table jobtitles_lookup
drop table employers_lookup
drop table workstations_lookup
drop table students
