...
if EXISTS (SELECT * from INFORMATION_SCHEMA.TABLE_CONSTRAINTS
   WHERE CONSTRAINT_NAME = 'paychecks_FK')
   ALTER table paychecks drop CONSTRAINT paychecks_FK
...
INSERT into schedules values( '17:00:0  0','21:00:00', '2021-11-22', 'Monday')
...
CREATE VIEW Sadler_Schedule AS
